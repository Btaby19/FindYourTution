...
if ($_SESSION["type"] == "student") {
    ...
    $sql = "UPDATE tutors SET tutor_name='" . $_GET["name"] . "', area_name='" . $_GET["area"] . "', address='" . $_GET["address"] . "', age=" . $_GET["age"] . ", class='" . $_GET["class"] . "', background='" . $_GET["medium"] . "', institute='" . $_GET["institute"] . "', phone=" . $_GET["phone"] . ", tutor_password='" . $_GET["tutor_password"] . "' WHERE tutor_id=" . $_SESSION['id'];
