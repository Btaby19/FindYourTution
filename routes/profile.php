                                    ...
                                    <table class="table table-striped table-advance table-hover">
                                        ...
                                        <?php while ($row2 = $result2->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="label label-info label-mini"><?php echo $row2["tution_duration"] ?></span>
                                                </td>
                                ...
                                <div id="contact" class="tab-pane">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 detailed">
                                            <form role="form" class="form-horizontal" action="../core/requiremts.php"
                                                  method="get">
                                                <div class="col-lg-6 detailed">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" placeholder="Bangla"
                                                                   name="tutor_background"
                                                                   class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                ...
                                <form role="form" class="form-horizontal" action="../core/profile.php" method="get">
                                    <div class="col-lg-6 detailed">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" placeholder=" " name="institute"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" placeholder=" " name="student_group"
                                                       value='<?php echo $row["student_group"] ?>'
                                                       class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" placeholder=" " name="medium"
                                                       value='<?php echo $row["medium"] ?>'
                                                       class="form-control">
                                            </div>
                                        </div>
...
<?php } else { ?>
    <section id="main-content" style="margin-left: 0px;">
        <section class="wrapper site-min-height">
            <?php include '../core/database.php' ?>
            <?php
            $sql = "SELECT * from tutors where tutor_id=" . $_SESSION['id'];
            $result = $conn->query($sql);
            $row = $result->fetch_assoc(); ?>
            <div class="row mt">
                <div class="col-lg-12">
