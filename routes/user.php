...
<section id="main-content" style="margin-left: 0px;">
    <section class="wrapper site-min-height">
        ...
        if($_SESSION["type"] == "teacher") {
                    ...
                    <div class="row content-panel">
                        ...
                        <div class="col-md-4 centered">
                            <div class="profile-pic">
                                ...
                                <p>
                                    <a href="compose.php?to=<?php echo $_GET['id']; ?>" class="btn btn-theme"><i
            ...
            $sql = "SELECT * from tutors where tutor_id=" . $_GET['id'];
            $result = $conn->query($sql);
            $row = $result->fetch_assoc(); ?>
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="row content-panel">
                        ...
                        <div class="col-md-4 centered">
                            <div class="profile-pic">
                                <p><img src="img/ui-sam.jpg" class="img-circle"></p>
                                <p>
                                    <a href="../core/request.php?to=<?php echo $_GET['id']; ?>" class="btn btn-theme"><i
                                                class="fa fa-envelope"></i> Add Request
                                    </a>
                                </p>
